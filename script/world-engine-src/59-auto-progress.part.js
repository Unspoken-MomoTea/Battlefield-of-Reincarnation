    ...
    class WorldAutoProgressFeature {
        ...
        beforeRun(){try{this.runSnapshot=this.engine.snapshot();}catch(_){this.runSnapshot=null;}}
        afterRun(context){if(context?.success===true)this.markAutoProgressRun(this.runSnapshot);this.runSnapshot=null;}
        toggleAutoProgress(){
    ...
    registerWorldEngineFeature('auto-progress',engine=>new WorldAutoProgressFeature(engine));
