        ...
        render(force) {
            ...
            const viewContext={
                s,w,state,orbit,events,active,future,people,calendarCandidates,snapshot,
                entries,text,empty,section,stabilityDescription,parseDate,calendar,tools,timelineCards,
                exists,fields,prose,compactPerson,radar,showRadar,alienAlive,formalPeople,backstagePeople,
                relationRoster,matched,userName,pill,contextRows,sceneContextBody,person,value,areaSceneBody,
                details,eventCard,relationNamesByKey,plain
            };
            const renderedView=this.services?.views?.render(this.tab,viewContext);
