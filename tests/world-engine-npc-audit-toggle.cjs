...
function freshState(){
  ...
  backend.势力地区['藤美学园天台']={
    ...clone(RECORDS.势力地区),类型:'地区',描述:'主教学楼顶部的临时避难区。',目标:'守住天台入口',进展:'铁门仍在承受死体撞击。',
    关联事件:['天台入口攻防'],公开动态:'幸存者正在加固入口。'
  };
  backend.势力地区['校内守备组']={
    ...clone(RECORDS.势力地区),类型:'势力',描述:'由幸存师生临时组成的守备组织。',目标:'保护天台幸存者',进展:'维持入口防线。',
    关联事件:['天台入口攻防'],公开动态:'守备组轮流加固铁门。'
  };
  return {
    世界:{
      名称:'学园默示录',时间:'2010年-04月-13日-上午',地点:'藤美学园-主教学楼-天台',稳定:100,后台:backend,
      因果轨道:{当前阶段:'爆发初期',故事线:'',下一节点:'',偏移记录:{}},异端雷达:{名单:{}},
      势力:{校内守备组:{实力:'F',领地:'藤美学园天台',描述:'由幸存师生临时组成的守备组织。',声望:0}},探索:{},法则:[],货币:{},历法:{}
    },
...
(async()=>{
...

  {
    const reply=JSON.stringify({
      摘要:'补全玛雅的既有森精灵血统构筑，同时天台防线继续加固。',
      势力地区:[{名称:'藤美学园天台',操作:'更新',类型:'地区',描述:'主教学楼顶部的临时避难区。',目标:'守住天台入口',进展:'幸存者把更多桌椅推到铁门后方继续加固。',关联事件:['天台入口攻防'],公开动态:'天台入口防线继续加固。'}],
      关系:[{
        名称:'玛雅',操作:'更新',
        血统:{
          森精灵血统:{
