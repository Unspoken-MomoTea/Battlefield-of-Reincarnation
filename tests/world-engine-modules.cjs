...
for(const moduleName of ['services/00-domain-services.part.js','services/10-request-history-services.part.js','services/20-request-builder.part.js','services/30-run-service.part.js','ui/00-styles.part.js','ui/10-world-tab.part.js','ui/20-people-tab.part.js','ui/30-exploration-tab.part.js','ui/40-archive-tabs.part.js','ui/50-settings-tab.part.js','ui/60-prompt-tab.part.js','ui/70-request-inspector.part.js','ui/80-view-classes.part.js','editor/00-world-mutations.part.js','editor/10-event-editor.part.js','editor/20-person-editor.part.js','59-all-editable-prompts.part.js']){
