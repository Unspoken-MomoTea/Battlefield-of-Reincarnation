...
- 开局伙伴的人设区在“背景故事”下方提供可选“填写世界书”按钮。开启后文本框会立即自动填入姓名、种族、身份、层级、性格、喜爱、背景故事等前序，并预留“背景设定”；修改上方基础资料时只同步前序，不覆盖作者已经填写的背景设定。发布后生成与普通世界书角色相同的“角色定义后 / 顺序600”世界书。未开启，或开启后内容为空时，不生成世界书 artifact。
