    class SamsaraWorldEngine {
        ...
        buildRetryInput(baseInput,error,lastReply,attempt,maxAttempts,acceptedResult,retryPlan=[]) {
            ...
            return retryInput(baseInput,error,lastReply,attempt,maxAttempts,acceptedResult,retryPlan,this.services?.prompts||null);
        }
        schedule() {
        ...
        async run() {
            ...
            try {
                ...
                while(attempt<maxAttempts){
                    ...
                    const attemptInput=attempt===0?request.input:this.buildRetryInput(request.input,lastError,lastRejectedReply,attempt,maxAttempts,acceptedWorldResult,lastRetryPlan);
