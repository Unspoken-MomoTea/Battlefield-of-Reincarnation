        ...
        async run() {
            ...
            try {
                ...
                while(attempt<maxAttempts){
                    ...
                    const attemptInput=attempt===0?request.input:retryInput(request.input,lastError,lastRejectedReply,attempt,maxAttempts,acceptedWorldResult,lastRetryPlan,this.services?.prompts?.retryPrompts?.());
