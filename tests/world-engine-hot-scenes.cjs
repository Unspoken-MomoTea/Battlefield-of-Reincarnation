...
const data = {
  世界: {
    ...
    后台: {
      ...
      势力地区: {
        '东部王国-暴风城-法师区': { 类型: '地区', 更新时间: now, 控制方: '暴风城王国', 环境状态: ['魔网稳定'], 现场群体: [{ 名称: '法师学徒', 规模: '数十', 身份: '施法者', 动态: '维持高塔结界' }], 资源点: [{ 名称: '传送大厅', 类型: '交通', 状态: '开放', 控制方: '肯瑞托', 动态: '通行正常' }] },
        '东部王国-西瘟疫之地-安多哈尔': { 类型: '地区', 更新时间: now, 控制方: '白银之手', 环境状态: ['瘟疫迷雾'], 现场群体: [{ 名称: '白银之手残军', 规模: '24人', 身份: '守军', 动态: '重建南门防线' }], 资源点: [{ 名称: '南门粮仓', 类型: '补给', 状态: '紧缺', 控制方: '白银之手', 动态: '余粮下降' }] },
        '卡利姆多-奥格瑞玛': { 类型: '地区', 更新时间: now, 控制方: '部落', 环境状态: ['军队集结'], 现场群体: [], 资源点: [] },
        '诺森德-冰冠堡垒': { 类型: '地区', 更新时间: '昨日', 控制方: '远征军', 环境状态: ['寒风'], 现场群体: [], 资源点: [] },
        '外域-沙塔斯': { 类型: '地区', 更新时间: now, 控制方: '沙塔尔', 环境状态: ['难民涌入'], 现场群体: [{ 名称: '外域难民', 规模: '数百', 身份: '平民', 动态: '进入贫民窟' }], 资源点: [] },
        '东部王国-湿地': { 类型: '地区', 更新时间: '黑暗之门历80年', 控制方: '', 环境状态: ['旧记录'], 现场群体: [], 资源点: [] },
      },
    },
  },
  系统状态: { 是否在主神空间: false },
