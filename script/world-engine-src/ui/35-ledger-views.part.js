    class WorldEngineAssetView extends WorldEngineView {
        render(ctx){
            const {s,w,userName,relationNamesByKey,people,entries,plain,matched,tools,section,text,pill,fields,details,empty}=ctx;
    ...
    class WorldEngineRumorView extends WorldEngineView {
        render(ctx){
            const {s,state,tools,entries,matched,section,text,fields,details,empty,pill}=ctx;
            let html=tools();
