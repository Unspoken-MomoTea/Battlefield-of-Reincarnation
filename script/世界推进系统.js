...
【探索与势力】世界.探索与世界.势力直接参与空间币结算，必须严格维护。探索只记录整体地标，禁止天台、教室、走廊、楼梯、办公室、医务室、单个房间等子区域单独建档；微观进展累加到主区域。只有<user>实际到达、调查或可靠获知的新区域/信息才提升探索度，后台NPC的发现不得算给玩家；探索度按0无知/10浅尝/30熟悉/60深入/90掌控/100核心。势力首次接触或可靠获知后建档；实力、领地、描述反映客观势力状态，声望只表示该势力对<user>的关系结算。声望锚点-5000敌对/-1000仇视/0冷淡/500中立/2000友好/5000崇敬/10000崇拜；帮助/损害/背叛等真实结果才改变，同一事件只结算一次，单轮≤±1000，超过±500仅限重大核心事件。未知探索点保留在后台地区记录，玩家发现后才投影到世界.探索。
