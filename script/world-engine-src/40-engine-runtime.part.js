    class SamsaraWorldEngine {
        ...
        async buildRequest(base) {
            ...
            const macroRequirement=this.config.requireMacroBackbone!==false&&timeline.需要补充远期?{
                ...
                规划与发生:worldPromptRuntimeValue('macroPlanning'),
                验收:worldPromptRuntimeValue('macroAcceptance')
            }:undefined;
            ...
            const input=JSON.stringify({
                输入语义:{
                    世界书:worldPromptRuntimeValue('inputWorldbookSemantics'),
                    当前变量:worldPromptRuntimeValue('inputCurrentStateSemantics'),
                    正文楼层:worldPromptRuntimeValue('inputProseSemantics'),
                    程序结构修复:worldPromptRuntimeValue('inputStructureRepairSemantics'),
                    时间线调度:worldPromptRuntimeValue('inputTimelineSemantics'),
                    WorldResult:worldPromptRuntimeValue('inputWorldResultSemantics'),
                    角色管理:worldPromptRuntimeValue('inputCharacterAuditSemantics')
                },
                ...
                正文可见投影规则:{
                    当前时间:state.世界.时间,
                    当前地点:state.世界.地点,
                    要求:worldPromptRuntimeValue('proseProjectionRule')
                },
                ...
                生命周期整理:lifecycle,
                说明:worldPromptRuntimeValue('requestFinalNote')
            },null,2);
