...
- 世界书角色直接填写人物资料并自动生成世界书条目；生成条目固定放在“角色定义后（↓ Char）”的角色区间，顺序 650、概率 100，位于项目世界书的“角色开始 600 / 角色结束 700”之间。开局角色/开局伙伴使用表单填写角色资料，不再维护职业字段，层级仅允许Ⅰ-Ⅲ。血统与技能品质由人物层级自动锁定为Ⅰ→F、Ⅱ→E、Ⅲ→D。
