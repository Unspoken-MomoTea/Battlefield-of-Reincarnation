...
(function () {
    ...
    function renderEquipFullList(equips, basePath, editMode, statuses) {
        ...
        filtered.forEach(function(it) {
            ...
            if (e.消耗 && e.消耗 !== '0' && e.消耗 !== 0 && e.消耗 !== '' && e.消耗 !== '无') rows += fcRow('消耗', e.消耗, path+'.消耗', editMode);
    ...
    function renderSkillFullList(skills, basePath, editMode) {
        ...
        cats.forEach(function(cat) {
            ...
            list.forEach(function(it) {
                ...
                var rows = '';
                if (s.消耗 && s.消耗 !== '0' && s.消耗 !== 0 && s.消耗 !== '' && s.消耗 !== '无') rows += fcRow('消耗', s.消耗, path+'.消耗', editMode);
                var body = '<div class="sam-fc-body">';
    ...
    function renderBloodTab(sd) {
        ...
        if (fkeys.length === 0) fHtml += '<div class="sam-empty">[无形态]</div>';
            ...
            fkeys.forEach(function(k) {
                ...
                if (f.消耗 && f.消耗 !== '0' && f.消耗 !== 0 && f.消耗 !== '' && f.消耗 !== '无') rows += fcRow('消耗', f.消耗, path+'.消耗', editMode);
