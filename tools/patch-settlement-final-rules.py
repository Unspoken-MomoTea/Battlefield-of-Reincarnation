...
old_credential = '''          // SETTLEMENT_CREDENTIAL_CORE_START
...
new_credential = '''          // SETTLEMENT_CREDENTIAL_CORE_START
          ...
          // SETTLEMENT_CREDENTIAL_CORE_END
'''
replace_once(old_credential, new_credential, 'credential world-mode split')

path.write_text(text, encoding='utf-8')
print('final settlement rules patched')
