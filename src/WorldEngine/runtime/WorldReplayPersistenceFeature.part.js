    ...
    class WorldReplayPersistenceFeature {
        constructor(engine){this.engine=engine;this.baseHandle=null;}
        initialize(){
            const e=this.engine;
            this.baseHandle=typeof e.handleWorldReplayVariableEvent==='function'?e.handleWorldReplayVariableEvent.bind(e):null;
