...
b.事件={
 '灰港封锁':{...RECORDS.事件,描述:'守备队封锁北门，调查失踪的补给车队。',时间:'2026年9月7日清晨',地点:'灰港 · 北门',状态:'进行中',前因:[],公开征兆:'巡逻队增派人手，通行审查趋于严格。',参与者:['守备官艾琳','灰港卫队'],关联任务:['追查失踪车队'],条件:'补给中断后调查启动',预计结束:'2026年9月8日傍晚'},
 '商会紧急议事':{...RECORDS.事件,描述:'商会将商议备用粮路，决定是否雇佣护卫。',时间:'2026年9月8日下午',地点:'旧城 · 商会大厅',状态:'待发生',前因:['灰港封锁'],公开征兆:'商会向各家粮商发出紧急邀请。',参与者:['商人莱昂'],默认走向:'若商路仍不通，发布护送委托。'},
...
const stat={世界:{名称:'灰港纪事',地点:'灰港 · 银鸥酒馆',时间:'2026年9月7日清晨',稳定:96,后台:b,因果轨道:{当前阶段:'第一幕 · 北境来信',故事线:'补给中断 → 旧桥调查 → 商路争夺',下一节点:'商会紧急议事',偏移记录:{}},法则:['低魔世界','契约具有约束力'],货币:{体系:'银冠',经济波动:'粮价小幅上涨'},势力:{灰港商会:{实力:'C',声望:320,领地:'灰港集市',描述:'希望尽快恢复北方商路。'}},探索:{废弃旧桥:{风险:'D',探索度:35,描述:'桥头留有车轮与拖拽痕迹。',隐藏真相:'桥下存在一条隐蔽通道。'}},异端雷达:{名单:{}}},系统状态:{游玩天数:23,是否在主神空间:false},设置:{},关系列表:{商人莱昂:{在场:true,好感度:25,态度:'愿意交换消息'},守备官艾琳:{在场:false,好感度:10}},任务:{列表:{追查失踪车队:{状态:'进行中',目标:'沿北境旧驿道寻找失踪的补给车队。',委托方:'灰港卫队',难度:'D',奖励:'200银冠'}},副本成就:{迷雾中的足迹:{状态:'未达成',说明:'在补给危机结束前找到旧桥的秘密。',难度:'D',奖励:'D级盲盒'}}},传闻:{街头巷议:{粮仓里的低语:{来源:'酒馆常客',内容:'听说北门外又停了两支商队，面包恐怕还要涨价。',可信度:'或许可信'}}}};
(async()=>{
