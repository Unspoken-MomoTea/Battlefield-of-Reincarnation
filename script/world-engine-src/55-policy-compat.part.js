    ...
    class WorldNpcAuditFeature {
        ...
        async modifyRequest(request){this.syncFeature();return request;}
        async beforeRun(){
            this.syncFeature();
        ...
        async afterRun(){
            const samsara=this.engine.host&&this.engine.host.Samsara;
    ...
    registerWorldEngineFeature('npc-audit',engine=>new WorldNpcAuditFeature(engine));
