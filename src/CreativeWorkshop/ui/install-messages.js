const CONFLICT_LABELS = {
  ...
  original_conflict_target_missing: issue => `找不到需要关闭的原版世界书条目“${issue.name}”`,
  original_conflict_target_ambiguous: issue => `原版世界书条目“${issue.name}”匹配到 ${issue.count} 项，请作者指定世界书或 UID`,
  ...
  original_regex_target_invalid: issue => `原正则状态规则不能指向这个工坊项目自己安装的正则“${issue.name}”`,
  ...
  original_script_target_invalid: issue => `原脚本冲突不能指向这个工坊项目自己安装的脚本“${issue.name}”`,
