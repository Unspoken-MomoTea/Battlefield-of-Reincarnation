...
(async()=>{
 ...
 await page.locator('[data-segment-row] > summary').first().click();
 await page.locator('[data-segment]').first().fill('测试分段修改');
 await page.locator('[data-structure-prompt]').locator('..').locator('summary').click();
